...
namespace
{
	...
	kueken::texture::name TextureSplash;
...
void CMain::Render()
{
...

	{
		...
		Renderer->bind(TextureSplash, kueken::texture::SLOT0);
...
bool CMain::initSampler()
{
...

	{
		...
		Creator.setWrap(kueken::sampler::CLAMP, kueken::sampler::CLAMP, kueken::sampler::CLAMP);
